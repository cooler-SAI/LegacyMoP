...
class spell_sha_fire_nova : public SpellScriptLoader
{
    public:
        ...
        class spell_sha_fire_nova_SpellScript : public SpellScript
        {
            ...
            {
                UnitList targets;
                Skyfire::AnyUnitHavingBuffInObjectRangeCheck u_check(GetCaster(), GetCaster(), 100, SPELL_SHA_FLAME_SHOCK, false);
                Skyfire::UnitListSearcher<Skyfire::AnyUnitHavingBuffInObjectRangeCheck> searcher(GetCaster(), targets, u_check);
